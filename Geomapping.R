  ...
  "))
    ...
    tabsetPanel(tabPanel("Home",icon = icon("home", class = "btn-sm btn-info"),
                ...
                tabPanel("Visualization",icon= icon("area-chart", class = "btn-sm btn-success"),
                         fluidRow(
                           column(4, selectInput("variables","Select Variable Column", choices = names(hospitals1)[c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "COUNTRY" ),
                                  selectInput("variables1","Select Variable Column", choices = names(hospitals1)[-c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "ARTISTS_COUNTRY" ),
                                  submitButton("comot work", icon = icon("check-square", class = "btn-sm btn-info") )),
                           column(8, plotlyOutput("plota", height= "4500px", width= "100%"))),
                         fluidRow(
                           column(4, textOutput("texta")), column(8, dataTableOutput("tablea"))
                         ),
                         fluidRow(
                           column(4, selectInput("variables2","Select Variable Column", choices = names(hospitals1)[-c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "COUNTRY" ),
                                  selectInput("variables3","Select Variable Column", choices = names(hospitals1)[-c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "ARTISTS_COUNTRY" ),
                                  submitButton("check am", icon = icon("check-square", class = "btn-sm btn-info") )),
                           column(8, plotlyOutput("plot1a", height= "4500px", width= "100%"))),
                         fluidRow(
                           column(4, textOutput("text1a")), column(8, dataTableOutput("table1a"))
                         ),
                         fluidRow(
                           column(4, selectInput("variables4","Select Variable Column", choices = names(hospitals1)[-c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "ARTISTS_COUNTRY" ),
                                  submitButton("May We See", icon = icon("check-square", class = "btn-sm btn-info") )),
                           column(8, plotlyOutput("plot2a", height= "4500px", width= "100%"))),
                         fluidRow(
                           column(4, textOutput("text2a")), column(8, dataTableOutput("table2a"))
                         ),
                         fluidRow(
                           column(4, selectInput("variables5","Select Variable Column", choices = names(hospitals1)[-c(2,3,4,5,7,8,9,17,18,19,20,21,22,23,24,25)], selected = "ARTISTS_COUNTRY" ),
                                  submitButton("Show person", icon = icon("check-square", class = "btn-sm btn-info") )),
                           column(8, plotlyOutput("plot3a", height= "4500px", width= "100%"))),
                         fluidRow(
